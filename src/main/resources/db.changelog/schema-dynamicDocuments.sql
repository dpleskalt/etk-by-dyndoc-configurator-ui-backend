...
ALTER TABLE THR_OBJECT_ITEMS ADD COLUMN DECIMAL_PLACES INTEGER;
ALTER TABLE THR_OBJECT_DEFAULT ADD COLUMN DECIMAL_PLACES INTEGER;
ALTER TABLE THR_OBJECT_ITEMS_HIS ADD COLUMN DECIMAL_PLACES INTEGER;

ALTER TABLE THR_OBJECT_CLASS
ADD COLUMN INPUT_FORM VARCHAR(1);
...
CREATE TABLE thr_object_events
(
...
CREATE TABLE thr_object_events_class
...
CREATE TABLE thr_object_events_type
...
CREATE TABLE THR_OBJECT_SECTIONS
(
